...
<head>
    ...
    <style>
        ...
        .sidebar {
            ...
            z-index: 100;
            top: 0;
            left: -280px; /* Default: tersembunyi */
        ...
        @media (min-width: 760px) {
            .sidebar {
                left: 0; /* Sidebar selalu terlihat di desktop */
            }
            .header {
                padding-left: calc(1rem + 280px); /* Geser header agar tidak menimpa sidebar */
            }
            .header .icon.hamburger {
                display: none; /* Sembunyikan hamburger icon */
            }
            .main-content {
                margin-left: 280px; /* Tambahkan margin untuk konten utama */
            }
            .backdrop {
        ...
        .product-card .price-item.vip {
            ...
            box-shadow: 0 5px 15px rgba(255, 215, 0, 0.5); /* FIX: Corrected typo */
        }
        ...
        .preset-card .video-wrapper {
            position: relative;
            width: 100%;
            padding-top: 177.77%; /* Rasio 9:16 untuk video vertikal */
        ...
        .tiktok-downloader #resultArea .video-info {
        ...
        .tiktok-downloader #resultArea .video-info h3 {
            color: var(--neon-cyan);
            margin-top: 0;
            text-shadow: 0 0 5px var(--neon-shadow);
        }
        
        .tiktok-downloader #resultArea .video-info p {
            margin: 0.5rem 0;
        }
        
        .tiktok-downloader #resultArea .download-links {
            display: flex;
            flex-direction: row;
            flex-wrap: wrap;
            justify-content: center;
        ...
        .tiktok-downloader #resultArea .download-links a,
        .tiktok-downloader #resultArea .download-links button {
            display: block;
            padding: 0.75rem;
            text-align: center;
            border-radius: 5px;
        ...
        .tiktok-downloader #resultArea .download-links .btn-video-nowm {
            background-color: var(--neon-cyan);
            color: var(--btn-text);
        }
        
        .tiktok-downloader #resultArea .download-links .btn-video-nowm:hover {
            background-color: #00b8d4;
        }
        
        .tiktok-downloader #resultArea .download-links .btn-music {
            background-color: #e91e63;
            color: #fff;
        }
        
        .tiktok-downloader #resultArea .download-links .btn-music:hover {
        ...
        .media-uploader #uploadResult, .media-uploader #mediafireUploadResult {
            margin-top: 2rem;
            text-align: left;
            word-wrap: break-word;
        }
        
        .media-uploader #uploadResult .result-box, .media-uploader #mediafireUploadResult .result-box {
            background-color: var(--light-card-bg);
            padding: 1.5rem;
            border-radius: 10px;
            border: 1px solid var(--neon-cyan);
        ...
        .media-uploader #uploadResult .result-box a, .media-uploader #mediafireUploadResult .result-box a {
            color: var(--neon-cyan);
            word-break: break-all;
        }
        ...
        #pinterest-downloader #resultArea img, #pinterest-downloader #resultArea video {
            max-width: 100%; /* MEMASTIKAN TIDAK MELEBIHI LEBAR ASLI */
            height: auto; /* MEMPERTAHANKAN RASIO ASPEK */
            border-radius: 10px;
            margin-bottom: 1rem;
        }
        #pinterest-downloader #resultArea .download-links {
            justify-content: center;
        }
        
        /* --- Gaya Khusus All Sosmed Downloader --- */
        .all-sosmed-downloader .result-box {
            background-color: var(--light-card-bg);
            padding: 1.5rem;
            border-radius: 10px;
            border: 1px solid var(--neon-cyan);
        ...
        .all-sosmed-downloader .result-box h4 {
            color: var(--neon-cyan);
            margin-top: 0;
            margin-bottom: 1rem;
        }

        .all-sosmed-downloader .media-display {
            display: flex;
            flex-direction: column;
            gap: 1rem;
        }
        
        .all-sosmed-downloader .media-display img,
        .all-sosmed-downloader .media-display video {
            max-width: 100%;
            height: auto;
            border-radius: 8px;
            display: block;
        ...
        .all-sosmed-downloader .media-display a {
...
<body>
    <div id="sidebar" class="sidebar">
        ...
        <a href="#all-sosmed-downloader" class="menu-item"><span class="icon fas fa-download"></span>All Sosmed Downloader</a>
    ...
    <main class="main-content">
        ...
        <div id="payment" class="content-section">
            <div class="hero-section">
                ...
                <p>✨ Halaman ini akan berisi informasi tentang metode pembayaran yang tersedia.</p>
        ...
        <div id="produk" class="content-section">
            <div class="product-card">
                <div class="product-title">╔━━━[ ??𝐏𝐄𝐍 𝐌𝐔𝐑𝐁𝐀𝐍/𝐉𝐀𝐒𝐀 𝐁𝐀𝐍 ]━━━╗</div>
        ...
        <div id="sc-bot" class="content-section">
            <div class="hero-section">
                ...
                <div class="version">v1.0</div>
                <p>✨ Halaman ini akan berisi daftar dan deskripsi SC bot Telegram gratis.</p>
                <a href="https://t.me/rofikos" class="btn-github">
                    <span class="fab fa-telegram"></span> Hubungi Admin
                </a>
            </div>
        ...
        <div id="alight-motion-preset" class="content-section">
            <div class="hero-section">
                ...
                <div class="version">v1.0</div>
                <p>✨ Di sini kamu bisa download preset Alight Motion favoritmu, lengkap dengan video contohnya.</p>
            </div>
        ...
        <div id="pinterest-downloader" class="content-section">
            <div class="pinterest-downloader">
                ...
                <div id="pinterestResultArea" style="display: none; flex-direction: column; gap: 1.5rem; margin-top: 2rem; text-align: left;">
                    <div class="media-container" style="text-align: center;">
                        </div>
                    <div class="video-info" style="background-color: var(--light-card-bg); padding: 1.5rem; border-radius: 10px; border: 1px solid var(--neon-cyan); box-shadow: 0 0 10px var(--neon-shadow);">
                        <h3>Informasi Konten</h3>
                        <p><strong>Judul:</strong> <span id="pinterestTitle"></span></p>
                    </div>
                    <div class="download-links" style="display: flex; flex-direction: row; flex-wrap: wrap; justify-content: center; gap: 1rem;">
                        <a id="btnDownloadPinterest" class="download-btn" href="#" target="_blank">
        ...
        <div id="all-sosmed-downloader" class="content-section">
            <div class="all-sosmed-downloader">
                <h1>All Sosmed Downloader</h1>
                <p>Download konten dari berbagai platform media sosial.</p>
                <div class="input-group">
                    <input type="text" id="allSosmedUrlInput" placeholder="Masukkan link sosmed..." autocomplete="off">
                    <button id="downloadAllSosmedBtn">Download</button>
                </div>

                <div id="allSosmedResultArea" style="display: none;">
                    <div class="result-box">
                        <h4>Hasil Download</h4>
                        <div id="allSosmedMediaDisplay" class="media-display">
                            </div>
                        <div class="download-links" style="margin-top: 1rem; display: flex; flex-direction: column; gap: 0.5rem;">
                            </div>
                    </div>
                </div>

                <div id="allSosmedStatusMessage" class="status-message"></div>
            </div>
        </div>
    ...
    <script>
        ...
        const tiktokResultArea = document.getElementById('resultArea');
            ...
            downloadTiktokBtn.addEventListener('click', async () => {
                ...
                try {
                    ...
                    if (response.ok && data.status === 'success' && data.data) {
                        ...
                        tiktokStatusMessage.innerText = `❌ Gagal: ${data.message || 'Terjadi kesalahan tidak diketahui.'}`;
                        lastTiktokVideoUrl = '';
                    ...
                    tiktokStatusMessage.style.backgroundColor = 'rgba(244, 67, 54, 0.2)';
                    tiktokStatusMessage.style.color = '#f44336';
                    tiktokStatusMessage.innerText = '❌ Terjadi kesalahan saat menghubungi API.';
                    lastTiktokVideoUrl = '';
                    btnUploadToCatbox.style.display = 'none';
                } finally {
        ...
        const pinterestResultArea = document.getElementById('pinterestResultArea');
        const pinterestMediaContainer = pinterestResultArea.querySelector('.media-container');
        ...
        if (downloadPinterestBtn) {
            downloadPinterestBtn.addEventListener('click', async () => {
                ...
                pinterestMediaContainer.innerHTML = '';
                ...
                try {
                    ...
                    if (response.ok && data.success && data.data) {
                        ...
                        if (data.type === 'video') {
                            ...
                            mediaElement.src = pinterestData.url;
                            mediaElement.controls = true;
                            mediaElement.setAttribute('poster', pinterestData.thumbnail);
                            downloadTypeSpan.innerText = 'Video';
                        } else {
                            mediaElement = document.createElement('img');
                            mediaElement.src = pinterestData.url;
                            mediaElement.alt = pinterestData.title || 'Pinterest Image';
                            downloadTypeSpan.innerText = 'Gambar';
                        }
                        
                        pinterestMediaContainer.appendChild(mediaElement);
                        ...
                        pinterestStatusMessage.innerText = `❌ Gagal: ${data.message || 'Terjadi kesalahan tidak diketahui.'}`;
                        pinterestResultArea.style.display = 'none';
                    }
                } catch (error) {
                    ...
                    pinterestStatusMessage.style.backgroundColor = 'rgba(244, 67, 54, 0.2)';
                    pinterestStatusMessage.style.color = '#f44336';
                    pinterestStatusMessage.innerText = '❌ Terjadi kesalahan saat menghubungi API.';
                    pinterestResultArea.style.display = 'none';
                } finally {
        ...
        // --- LOGIKA ALL SOSMED DOWNLOADER ---
        const downloadAllSosmedBtn = document.getElementById('downloadAllSosmedBtn');
        const allSosmedUrlInput = document.getElementById('allSosmedUrlInput');
        const allSosmedResultArea = document.getElementById('allSosmedResultArea');
        const allSosmedMediaDisplay = document.getElementById('allSosmedMediaDisplay');
        const allSosmedDownloadLinks = allSosmedResultArea.querySelector('.download-links');
        const allSosmedStatusMessage = document.getElementById('allSosmedStatusMessage');

        if (downloadAllSosmedBtn) {
            downloadAllSosmedBtn.addEventListener('click', async () => {
                const url = allSosmedUrlInput.value.trim();
                if (!url) {
                    alert('Silakan masukkan URL sosmed.');
                    return;
                }

                allSosmedStatusMessage.style.display = 'block';
                allSosmedStatusMessage.style.backgroundColor = 'rgba(0, 255, 242, 0.2)';
                allSosmedStatusMessage.style.color = 'var(--neon-cyan)';
                allSosmedStatusMessage.innerText = 'Sedang memproses, mohon tunggu...';
                downloadAllSosmedBtn.disabled = true;
                allSosmedResultArea.style.display = 'none';
                allSosmedMediaDisplay.innerHTML = '';
                allSosmedDownloadLinks.innerHTML = '';

                try {
                    const response = await fetch(`${CUSTOM_API_URL}/api/download-all-sosmed?url=${encodeURIComponent(url)}`);
                    const data = await response.json();

                    if (response.ok && data.status === 'success' && data.data) {
                        allSosmedResultArea.style.display = 'block';
                        allSosmedStatusMessage.style.display = 'none';
                        const resultData = data.data;

                        // Display media (video or image)
                        if (resultData.thumbnail) {
                            if (resultData.url && resultData.url.endsWith('.mp4')) {
                                allSosmedMediaDisplay.innerHTML += `<video controls src="${resultData.url}" poster="${resultData.thumbnail}"></video>`;
                            } else {
                                allSosmedMediaDisplay.innerHTML += `<img src="${resultData.thumbnail}" alt="Thumbnail">`;
                            }
                        }

                        // Display download links
                        if (resultData.url) {
                            allSosmedDownloadLinks.innerHTML += `<a href="${resultData.url}" download class="download-btn">Download Media</a>`;
                        } else if (resultData.audio) {
                             allSosmedDownloadLinks.innerHTML += `<a href="${resultData.audio}" download class="download-btn">Download Audio</a>`;
                        }
                        
                        // Handle multiple files if available
                        if (resultData.urls && Array.isArray(resultData.urls)) {
                            resultData.urls.forEach((item, index) => {
                                allSosmedDownloadLinks.innerHTML += `<a href="${item.url}" download class="download-btn">Download Media ${index + 1} (${item.quality})</a>`;
                            });
                        }
                        
                        if (resultData.music) {
                            allSosmedDownloadLinks.innerHTML += `<a href="${resultData.music}" download class="download-btn" style="background-color: #e91e63; color: white;">Download Music</a>`;
                        }
                        
                        // Simpan ke riwayat
                        saveToHistory({
                            type: 'all-sosmed',
                            title: resultData.title || `Konten dari ${new URL(url).hostname}`,
                            url: resultData.url || resultData.urls[0]?.url || 'Tidak ada URL utama'
                        });

                    } else {
                        allSosmedStatusMessage.style.backgroundColor = 'rgba(244, 67, 54, 0.2)';
                        allSosmedStatusMessage.style.color = '#f44336';
                        allSosmedStatusMessage.innerText = `❌ Gagal: ${data.message || 'Terjadi kesalahan. Pastikan URL valid.'}`;
                    }
                } catch (error) {
                    console.error('All Sosmed Download Error:', error);
                    allSosmedStatusMessage.style.backgroundColor = 'rgba(244, 67, 54, 0.2)';
                    allSosmedStatusMessage.style.color = '#f44336';
                    allSosmedStatusMessage.innerText = '❌ Terjadi kesalahan saat menghubungi server.';
                } finally {
                    downloadAllSosmedBtn.disabled = false;
                }
            });
        }
        ...
        if (btnUploadToCatbox) {
            btnUploadToCatbox.addEventListener('click', async () => {
                ...
                try {
                    ...
                    tiktokStatusMessage.style.backgroundColor = 'rgba(244, 67, 54, 0.2)';
                    tiktokStatusMessage.style.color = '#f44336';
                    tiktokStatusMessage.innerText = '❌ Terjadi kesalahan saat memproses permintaan.';
                    uploadResultBox.style.display = 'none';
                } finally {
